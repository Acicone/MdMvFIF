function options = Settings_MdMvFIF_v1(varargin)
% 
% SETTINGS_MDMVFIF_V1 Constructs option structure for the algorithms
%
% EXAMPLES
%
% OPTIONS = SETTINGS_MDMVFIF_V1 with no input arguments returns
%   setting structure with default values
%
% OPTIONS = SETTINGS_MDMVFIF_V1('NAME1',VALUE1,'NAME2',VALUE2,...) creates a
%   solution options structure OPTIONS in which the named properties have
%   the specified values.  Any unspecified properties have default values.
%   It is sufficient to type only the leading characters that uniquely
%   identify the property.  Case is ignored for property names.
%
% OPTIONS = SETTINGS_MDMVFIF_V1(OLDOPTIONS,'NAME1',VALUE1,...) alters an existing options
%   structure OLDOPTIONS.
%
%
% SETTINGS_MDMVFIF_V1 PROPERTIES :
%
% GENERAL
% 
%   saveEnd          - (0) If value is 1 save outputs in "name file"_decomp_MIF_2D_vXX.mat (only at termination)
%   saveInter        - (0) If value is 1 save outputs in "name file"_inter_decomp_MIF_2D_vXX.mat
%                      every inner step
%
...
% EXAMPLE
%          
%   >> options = Settings_MdMvFIF_v1('delta',0.08,'NIMFs',5,'plots',1) 
%   >> IMF = MdMvFIF_v1(x,options)
%              
%  Executes algorithm MdMvFIF_v1 with delta = 0.08, stop after we have at most 5 IMFs and a trend = 5, it produces plots.                            
% ------------------------------------------------------      
%
% See also FIF2_1_1, WEXTEND
%
%
...
%  Cambridge Core in Numerical Mathematics: Theory, Methods and Applications, 
%  Volume 10, Issue 2, Pages 278-298, 2017. doi:10.4208/nmtma.2017.s05 
...
if (nargin>0) && isstruct(varargin{1})
    ...
    options.MaxInner= 40;  % ho modificato questo valore prima era 200
    options.UseFFT=true;
